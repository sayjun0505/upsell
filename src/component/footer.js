export default function Header() {
    return (
        <>
            <div className="flex justify-center w-full bg-[#252F3D] h-[88px] ">
                <div className="flex flex-col md:flex-row w-11/12 justify-between text-white items-center leading-trim-both text-capitalize font-manrope text-base font-normal leading-6">
                    <div>Copyright (C) 2023 <span className="ml-3"></span>|<span className="ml-3"></span> clarifionsupport@clarifion.com</div>
                    <div className="flex flex-row justify-center items-center mt-6 md:mt-0">
                        ...
                        <span className="ml-3">Secure256-Bit SSLEncryption</span></div>
                </div>
            </div>
        </>
    )
